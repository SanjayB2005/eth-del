          ...
          <div className="py-20 text-center">
            <div className="mx-auto max-w-3xl">
              ...
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                Secure, blockchain-backed AI assistance with immutable session
                logging. Get support, manage evidence, and interact with Hedera
                blockchain operations in a trusted environment.
              </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Powered by Gemini Flash 2.5, our AI provides intelligent
                  support, blockchain operations guidance, and natural language
              ...
              <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Execute Hedera Consensus Service operations, manage topics,
                  send messages, and track all blockchain transactions in
                  real-time.
                </p>
              </div>
            </div>
