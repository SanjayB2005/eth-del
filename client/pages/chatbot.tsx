...
Generated by SafeGuard AI Platform - Women Safety & Support System
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      if (data.fallbackMode) {
        fallbackNotice =
          "⚠️ AI service temporarily unavailable - using fallback response. ";
      }
      ...
      if (data.type === "hedera_action") {
        ...
        aiMessage = {
          ...
          type: "ai",
          message: `${fallbackNotice}✅ Hedera action completed: ${
            data.action
  ...
  return (
    <>
      <Head>
        <title>SafeGuard AI Chatbot - Women Safety & Support Platform</title>
        <meta
          name="description"
          content="AI-powered chatbot with blockchain-secured session logging"
        />
            ...
            <div className="lg:col-span-1">
              ...
              <div className="mt-6 bg-gradient-to-r from-blue-50 to-indigo-50 p-4 rounded-lg border border-blue-200">
                ...
                <p className="text-xs text-blue-700 leading-relaxed">
                  All sessions are automatically logged to Hedera blockchain
                  using SHA-256 hashing for immutable audit trails while
